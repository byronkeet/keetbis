								...
								<div class="body">
									...
									<div class="content d-flex flex-column align-items-center justify-content-center text-center pt-6 pb-6">
										<div class="d-flex justify-content-around align-items-center back-info flex-column">
											...
											As part of <a href="https://github.com/hello-wp">Hello WP</a>, a 3 person team, we strive to create block-editor native plugins for WordPress.
											</p>
								...
								<div class="body">
									...
									<div class="content d-flex flex-column align-items-center justify-content-center text-center pt-6 pb-6">
										<div class="d-flex justify-content-around align-items-center back-info flex-column">
											...
											<p class="fs-6 text-white"><a href="https://github.com/byronkeet/DeadDropProductions" target="">DDP</a> was my first ever site built from the ground up using NodeJS, Express, HTML, CSS and JS. The site is for a music producer to download raw tracks from clients in order to mix and master the files before uploading the finished product to the cloud for downloading.</p>
